...
|---|---|---|
| [Blender Blockout as Seedance Motion Reference](#case-1) | Use this case to adapt blender blockout as seedance motion reference into a Blender-guided Seedance workflow. | Demo |
| [Camera Blocking with Midjourney Start Frame](#case-2) | Use this case to adapt camera blocking with midjourney start frame into a Blender-guided Seedance workflow. | Demo |
| [ComfyUI Camera Control with Blender Previs](#case-3) | Use this case to adapt comfyui camera control with blender previs into a Blender-guided Seedance workflow. | Demo |
| [Blender Viewport as Scene Direction](#case-4) | Use this case to adapt blender viewport as scene direction into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview for Character Animation](#case-5) | Use this case to adapt viewport preview for character animation into a Blender-guided Seedance workflow. | Demo |
| [Navigable AI Filmmaking with Claude and Blender](#case-6) | Use this case to adapt navigable ai filmmaking with claude and blender into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview to Realistic Start Frame](#case-7) | Use this case to adapt viewport preview to realistic start frame into a Blender-guided Seedance workflow. | Demo |
| [One Reference Video, Multiple Worlds](#case-8) | Use this case to adapt one reference video, multiple worlds into a Blender-guided Seedance workflow. | Demo |

### [🎬 Character & Action Blocking](#character-action-blocking)

| Case | What it shows | Type |
|---|---|---|
| [Multi-Character Dialogue with Matched Poses](#case-9) | Use this case to adapt multi-character dialogue with matched poses into a Blender-guided Seedance workflow. | Demo |
| [Basic Shapes for Multi-Character Shots](#case-10) | Use this case to adapt basic shapes for multi-character shots into a Blender-guided Seedance workflow. | Demo |
| [Action Choreography from Rough Blender Timing](#case-11) | Use this case to adapt action choreography from rough blender timing into a Blender-guided Seedance workflow. | Demo |
| [Handheld Follow Camera through Space](#case-12) | Use this case to adapt handheld follow camera through space into a Blender-guided Seedance workflow. | Demo |
| [Camera and Character Blocking for Tactical Action](#case-13) | Use this case to adapt camera and character blocking for tactical action into a Blender-guided Seedance workflow. | Demo |

### [🤖 Agentic Blender MCP](#agentic-blender-mcp)

| Case | What it shows | Type |
|---|---|---|
| [Codex + Blender MCP Reference Video Workflow](#case-14) | Use this case to adapt codex + blender mcp reference video workflow into a Blender-guided Seedance workflow. | Integration |
| [No-Click Blender Animation with Agent Assistance](#case-15) | Use this case to adapt no-click blender animation with agent assistance into a Blender-guided Seedance workflow. | Integration |
| [One-Prompt Blender MCP Blockout](#case-16) | Use this case to adapt one-prompt blender mcp blockout into a Blender-guided Seedance workflow. | Integration |
| [Codex-Built Architecture and Camera Work](#case-17) | Use this case to adapt codex-built architecture and camera work into a Blender-guided Seedance workflow. | Integration |
| [Beginner Agent-Assisted HIPHOP Reference Test](#case-18) | Use this case to adapt beginner agent-assisted hiphop reference test into a Blender-guided Seedance workflow. | Integration |
| [Codex MCP Direct Blender Export](#case-19) | Use this case to adapt codex mcp direct blender export into a Blender-guided Seedance workflow. | Integration |

### [🧩 Reference, Prompt & Multi-Input Mapping](#reference-prompt-multi-input-mapping)

| Case | What it shows | Type |
|---|---|---|
| [Reproducible Seedance Prompt with Blender Reference](#case-20) | Use this case to adapt reproducible seedance prompt with blender reference into a Blender-guided Seedance workflow. | Tutorial |
| [Character Mapping from Blocking and Reference Images](#case-21) | Use this case to adapt character mapping from blocking and reference images into a Blender-guided Seedance workflow. | Tutorial |
| [FBX Animation Export as Seedance Reference](#case-22) | Use this case to adapt fbx animation export as seedance reference into a Blender-guided Seedance workflow. | Tutorial |
| [Director Checklist for Camera and Lens Control](#case-23) | Use this case to adapt director checklist for camera and lens control into a Blender-guided Seedance workflow. | Tutorial |
| [Action Shot Direction with Blender Camera Planning](#case-24) | Use this case to adapt action shot direction with blender camera planning into a Blender-guided Seedance workflow. | Tutorial |
| [Mixamo Motion as Beginner Blender Reference](#case-25) | Use this case to adapt mixamo motion as beginner blender reference into a Blender-guided Seedance workflow. | Tutorial |
| [Composition Reference with Person and Vehicle Refs](#case-26) | Use this case to adapt composition reference with person and vehicle refs into a Blender-guided Seedance workflow. | Tutorial |

### [🛠️ Production Pipelines & Toolchains](#production-pipelines-toolchains)

| Case | What it shows | Type |
|---|---|---|
| [Hermes, Krea, ComfyUI and Blender MCP Stack](#case-27) | Use this case to adapt hermes, krea, comfyui and blender mcp stack into a Blender-guided Seedance workflow. | Integration |
| [Blender MCP Viewport to Seedance Style Transfer](#case-28) | Use this case to adapt blender mcp viewport to seedance style transfer into a Blender-guided Seedance workflow. | Integration |
| [Seedance Pro Viewport Style Transfer](#case-29) | Use this case to adapt seedance pro viewport style transfer into a Blender-guided Seedance workflow. | Integration |
| [Blender Previz to Anime Seedance Render](#case-30) | Use this case to adapt blender previz to anime seedance render into a Blender-guided Seedance workflow. | Integration |
| [FBX Clay Pass with Claude-Keyframed Camera](#case-31) | Use this case to adapt fbx clay pass with claude-keyframed camera into a Blender-guided Seedance workflow. | Integration |
| [Two-Night Hybrid Short Film Pipeline](#case-32) | Use this case to adapt two-night hybrid short film pipeline into a Blender-guided Seedance workflow. | Integration |

### [🧪 Limits, Tests & Troubleshooting](#limits-tests-troubleshooting)

| Case | What it shows | Type |
|---|---|---|
| [Camera Rhythm Control and Foot-Sliding Limits](#case-33) | Use this case to adapt camera rhythm control and foot-sliding limits into a Blender-guided Seedance workflow. | Limit |
| [Reference-Only Blender Blockout without Start Frame](#case-34) | Use this case to adapt reference-only blender blockout without start frame into a Blender-guided Seedance workflow. | Limit |
| [Mixamo Multi-Character Storyboard Experiment](#case-35) | Use this case to adapt mixamo multi-character storyboard experiment into a Blender-guided Seedance workflow. | Limit |
...
**Use this case to adapt blender blockout as seedance motion reference into a Blender-guided Seedance workflow.**

- Source notes: curated because the source describes a concrete Blender + Seedance workflow rather than a generic showcase.
...
**Use this case to adapt camera blocking with midjourney start frame into a Blender-guided Seedance workflow.**
...
**Use this case to adapt comfyui camera control with blender previs into a Blender-guided Seedance workflow.**
...
**Use this case to adapt blender viewport as scene direction into a Blender-guided Seedance workflow.**
...
**Use this case to adapt viewport preview for character animation into a Blender-guided Seedance workflow.**
...
**Use this case to adapt navigable ai filmmaking with claude and blender into a Blender-guided Seedance workflow.**
...
**Use this case to adapt viewport preview to realistic start frame into a Blender-guided Seedance workflow.**
...
**Use this case to adapt one reference video, multiple worlds into a Blender-guided Seedance workflow.**
...
**Use this case to adapt multi-character dialogue with matched poses into a Blender-guided Seedance workflow.**
...
**Use this case to adapt basic shapes for multi-character shots into a Blender-guided Seedance workflow.**
...
**Use this case to adapt action choreography from rough blender timing into a Blender-guided Seedance workflow.**
...
**Use this case to adapt handheld follow camera through space into a Blender-guided Seedance workflow.**
...
**Use this case to adapt camera and character blocking for tactical action into a Blender-guided Seedance workflow.**
...
**Use this case to adapt codex + blender mcp reference video workflow into a Blender-guided Seedance workflow.**
...
**Use this case to adapt no-click blender animation with agent assistance into a Blender-guided Seedance workflow.**
...
**Use this case to adapt one-prompt blender mcp blockout into a Blender-guided Seedance workflow.**
...
**Use this case to adapt codex-built architecture and camera work into a Blender-guided Seedance workflow.**
...
**Use this case to adapt beginner agent-assisted hiphop reference test into a Blender-guided Seedance workflow.**
...
**Use this case to adapt codex mcp direct blender export into a Blender-guided Seedance workflow.**
...
**Use this case to adapt reproducible seedance prompt with blender reference into a Blender-guided Seedance workflow.**
...
**Use this case to adapt character mapping from blocking and reference images into a Blender-guided Seedance workflow.**
...
**Use this case to adapt fbx animation export as seedance reference into a Blender-guided Seedance workflow.**
...
**Use this case to adapt director checklist for camera and lens control into a Blender-guided Seedance workflow.**
...
**Use this case to adapt action shot direction with blender camera planning into a Blender-guided Seedance workflow.**
...
**Use this case to adapt mixamo motion as beginner blender reference into a Blender-guided Seedance workflow.**
...
**Use this case to adapt composition reference with person and vehicle refs into a Blender-guided Seedance workflow.**
...
**Use this case to adapt hermes, krea, comfyui and blender mcp stack into a Blender-guided Seedance workflow.**
...
**Use this case to adapt blender mcp viewport to seedance style transfer into a Blender-guided Seedance workflow.**
...
**Use this case to adapt seedance pro viewport style transfer into a Blender-guided Seedance workflow.**
...
**Use this case to adapt blender previz to anime seedance render into a Blender-guided Seedance workflow.**
...
**Use this case to adapt fbx clay pass with claude-keyframed camera into a Blender-guided Seedance workflow.**
...
**Use this case to adapt two-night hybrid short film pipeline into a Blender-guided Seedance workflow.**
...
**Use this case to adapt camera rhythm control and foot-sliding limits into a Blender-guided Seedance workflow.**
...
**Use this case to adapt reference-only blender blockout without start frame into a Blender-guided Seedance workflow.**
...
**Use this case to adapt mixamo multi-character storyboard experiment into a Blender-guided Seedance workflow.**
