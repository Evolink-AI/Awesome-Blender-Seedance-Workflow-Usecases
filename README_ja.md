...
- **25 件の Blender + Seedance ケース** を、所有者提供の公開クリエイター投稿データから選定しました。
...
| セクション | ケース |
|---|---|
| [🎥 Camera Control & Previs / カメラ制御とプリビズ](#camera-control-previs) | Case 1, 2, 3, 4, 5 |
| [🎬 Character & Action Blocking / キャラクターとアクションのブロッキング](#character-action-blocking) | Case 6, 8, 9, 21 |
| [🤖 Agentic Blender MCP / エージェント型 Blender MCP](#agentic-blender-mcp) | Case 10, 11, 22 |
| [🧩 Reference, Prompt & Multi-Input Mapping / 参照、プロンプト、複数入力の対応付け](#reference-prompt-multi-input-mapping) | Case 13, 14, 23, 24, 26, 27 |
| [🛠️ Production Pipelines & Toolchains / 制作パイプラインとツールチェーン](#production-pipelines-toolchains) | Case 15, 16, 17, 18 |
| [🧪 Limits, Tests & Troubleshooting / 制限、検証、トラブルシュート](#limits-tests-troubleshooting) | Case 20, 25, 28 |
| [🙏 謝辞](#acknowledge) | Credits and correction policy |

<a id="camera-control-previs"></a>
### 🎥 Camera Control & Previs / カメラ制御とプリビズ
...
### 🎬 Character & Action Blocking / キャラクターとアクションのブロッキング
...
### 🤖 Agentic Blender MCP / エージェント型 Blender MCP
...
### 🧩 Reference, Prompt & Multi-Input Mapping / 参照、プロンプト、複数入力の対応付け
...
### 🛠️ Production Pipelines & Toolchains / 制作パイプラインとツールチェーン
...
### 🧪 Limits, Tests & Troubleshooting / 制限、検証、トラブルシュート
...
- ソースメモ: Merged with former case 7: together these sources show the full gray-box workflow and the action-previs variant with rough timing, speed, shake, and spatial choreography.
...
- ローカルメディアのバックアップ: [case1.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case1.mp4)
...
- ソースメモ: The source gives a clear three-step workflow and reports that the generated video tracks the Blender camera move closely.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/4bbd421d-dc83-4cae-927d-caa0f7aa143a

- ローカルメディアのバックアップ: [case2.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case2.mp4)
...
- ソースメモ: The case is useful because it combines Blender previz with multiple still references inside a ComfyUI-style control setup.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/987cf30d-de8b-4cf1-809a-5deaea8ceff0

- ローカルメディアのバックアップ: [case3.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case3.mp4)
...
- ソースメモ: The post gives a concise workflow with concrete artifacts: viewport preview, first-frame image, and Seedance reference video. The requested case 29 media is an exact duplicate of this video, so it is linked here instead of becoming a second public case.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:
...
- ローカルメディアのバックアップ: [case4.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case4.mp4), [case29.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case29.mp4)
...
- ソースメモ: The source is useful because it separates motion control from world/style variation using the same reference video.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/a6304e6a-d431-4cf7-9dd2-f664594e34c5

- ローカルメディアのバックアップ: [case5.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case5.mp4)
...
- ソースメモ: The source adds multi-character dialogue and pose matching, making it distinct from single-character camera-control demos.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/8f92ed66-1c9f-4fc1-885e-71240add8f56

- ローカルメディアのバックアップ: [case6.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case6.mp4)
...
- ソースメモ: The source moves the character through the scene while the camera follows, which makes it useful for handheld movement shots.
- Audit status: kept after manual duplicate and originality review.
...
- ソースメモ: The source shows simultaneous camera and character blocking, which is stronger than a simple camera-only reference.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/e92e6c44-3fef-4690-bce3-85de50ecf547

- ローカルメディアのバックアップ: [case9.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case9.mp4)
...
- ソースメモ: Requested as case 21. Kept as a distinct Reid Hannaford example because it pushes the workflow beyond a simple camera move into scene staging.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/a254edb3-245d-4bc0-87cc-45bd17e82b99

- ローカルメディアのバックアップ: [case21.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case21.mp4)
...
- ソースメモ: The author says the test was inspired by another creator, but the described scene, motion, camera, and export process are their own experiment.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/cff81cc4-0f72-49d8-881f-aee6ded2d5cf

- ローカルメディアのバックアップ: [case10.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case10.mp4)
...
- ソースメモ: The post is valuable as a beginner Codex workflow: the user delegates architecture and camera work to Codex before Seedance.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/247ccf17-4652-4c11-b8dc-efdba1567707

- ローカルメディアのバックアップ: [case11.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case11.mp4)
...
- ソースメモ: Requested as case 22. Kept because it demonstrates speed and agent control rather than manual Blender work.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/e9c22c6f-690f-4b3b-984c-a18506580c38

- ローカルメディアのバックアップ: [case22.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case22.mp4)
...
- ソースメモ: Merged with former case 19: the pair keeps both the reproducible setup and the limitation note about foot sliding.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:
...
- ソースメモ: The source is useful for beginners because it names Mixamo as a practical motion source for Blender reference videos.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/3f04e458-a43f-4860-af2b-88eb6dd397cc

- ローカルメディアのバックアップ: [case14.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case14.mp4)
...
- ソースメモ: Requested as case 23. Kept with the paired kan_mi_no9 test as a distinct reference-control variant.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/91721f79-eeaf-4309-bc4a-11e8136c6dba

- ローカルメディアのバックアップ: [case23.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case23.mp4)
...
- ソースメモ: Requested as case 24. Kept because it expands the reference-video idea beyond software-only previs.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/b6a3f37b-ef8c-46c1-ad53-a822797a7c09

- ローカルメディアのバックアップ: [case24.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case24.mp4)
...
- ソースメモ: Requested as case 26. Kept as the practical counterpart to the later kan_mi_no9 variation case.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/e63c102e-11cf-4381-87fe-8cfe0d96702b

- ローカルメディアのバックアップ: [case26.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case26.mp4)
...
- ソースメモ: Requested as case 27. Kept because it offers specific, reusable setup advice.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/71221c71-a7eb-428f-90e5-4a6111aaf890

- ローカルメディアのバックアップ: [case27.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case27.mp4)
...
- ソースメモ: The case demonstrates a broader agent-built creative stack, not just manual Blender previs.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/e1df0f87-e93e-4339-b25a-a7ac4c4f8c4e

- ローカルメディアのバックアップ: [case15.jpg](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case15.jpg), [case15.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case15.mp4)
...
- ソースメモ: This is the stronger techhalla source because it explains the viewport animation and downstream style/lighting step.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/80143b32-352b-4e86-8c1f-85826d940ba7

- ローカルメディアのバックアップ: [case16.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case16.mp4)
...
- ソースメモ: The source directly frames the workflow as Blender 3D previz transformed into an anime render while keeping camera motion.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/13ba8e79-0b0a-44b9-be29-9c850bdeb95a

- ローカルメディアのバックアップ: [case17.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case17.mp4)
...
- ソースメモ: The source gives a specific FBX-to-clay-pass process and includes camera keyframing before reference export.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/bccdbf9a-b816-403f-ae1f-6e43b1e295a3

- ローカルメディアのバックアップ: [case18.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case18.mp4)
...
- ソースメモ: This case covers an important variant where reference images replace the usual start-frame dependency.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/dfa129d8-f06b-4018-a5bb-c1ed9e78d0d3

- ローカルメディアのバックアップ: [case20.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case20.mp4)
...
- ソースメモ: Requested as case 25. Kept because it includes both working examples and a failed comparison.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/d333d2d0-8317-49f0-8815-86db783cb578

- ローカルメディアのバックアップ: [case25.jpg](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case25.jpg), [case25.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case25.mp4)
...
- ソースメモ: Requested as case 28. Kept as a concrete limitation/stress-test case.
- Audit status: kept after manual duplicate and originality review.
- 動画プレビュー:

https://github.com/user-attachments/assets/3ab561b2-ef3e-47a5-b2c4-8378a521e491

- ローカルメディアのバックアップ: [case28.mp4](https://github.com/cheercheung/Awesome-Blender-Seedance-Workflow-Usecases/raw/main/media/case28.mp4)
