...
Blender + Seedance のユースケース集です。

**Blender、Blender MCP、viewport、previs、FBX、Mixamo、ComfyUI、agent 支援で Seedance 動画生成を制御する実例を集めています。**
...
| [🙏 謝辞](#acknowledge) | Credits and correction policy |

### [🎥 Camera Control & Previs](#camera-control-previs)

| ケース | 内容 | Type |
|---|---|---|
| [Blender Blockout as Seedance Motion Reference](#case-1) | このケースは次に使えます: adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow. | Demo |
| [Camera Blocking with Midjourney Start Frame](#case-2) | このケースは次に使えます: adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [ComfyUI Camera Control with Blender Previs](#case-3) | このケースは次に使えます: adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow. | Demo |
| [Blender Viewport as Scene Direction](#case-4) | このケースは次に使えます: adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview for Character Animation](#case-5) | このケースは次に使えます: adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow. | Demo |
| [Navigable AI Filmmaking with Claude and Blender](#case-6) | このケースは次に使えます: adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview to Realistic Start Frame](#case-7) | このケースは次に使えます: adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [One Reference Video, Multiple Worlds](#case-8) | このケースは次に使えます: adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow. | Demo |

### [🎬 Character & Action Blocking](#character-action-blocking)

| ケース | 内容 | Type |
|---|---|---|
| [Multi-Character Dialogue with Matched Poses](#case-9) | このケースは次に使えます: adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow. | Demo |
| [Basic Shapes for Multi-Character Shots](#case-10) | このケースは次に使えます: adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow. | Demo |
| [Action Choreography from Rough Blender Timing](#case-11) | このケースは次に使えます: adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow. | Demo |
| [Handheld Follow Camera through Space](#case-12) | このケースは次に使えます: adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow. | Demo |
| [Camera and Character Blocking for Tactical Action](#case-13) | このケースは次に使えます: adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow. | Demo |

### [🤖 Agentic Blender MCP](#agentic-blender-mcp)

| ケース | 内容 | Type |
|---|---|---|
| [Codex + Blender MCP Reference Video Workflow](#case-14) | このケースは次に使えます: adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow. | Integration |
| [No-Click Blender Animation with Agent Assistance](#case-15) | このケースは次に使えます: adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow. | Integration |
| [One-Prompt Blender MCP Blockout](#case-16) | このケースは次に使えます: adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow. | Integration |
| [Codex-Built Architecture and Camera Work](#case-17) | このケースは次に使えます: adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow. | Integration |
| [Beginner Agent-Assisted HIPHOP Reference Test](#case-18) | このケースは次に使えます: adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow. | Integration |
| [Codex MCP Direct Blender Export](#case-19) | このケースは次に使えます: adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow. | Integration |

### [🧩 Reference, Prompt & Multi-Input Mapping](#reference-prompt-multi-input-mapping)

| ケース | 内容 | Type |
|---|---|---|
| [Reproducible Seedance Prompt with Blender Reference](#case-20) | このケースは次に使えます: adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Character Mapping from Blocking and Reference Images](#case-21) | このケースは次に使えます: adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow. | Tutorial |
| [FBX Animation Export as Seedance Reference](#case-22) | このケースは次に使えます: adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Director Checklist for Camera and Lens Control](#case-23) | このケースは次に使えます: adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow. | Tutorial |
| [Action Shot Direction with Blender Camera Planning](#case-24) | このケースは次に使えます: adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow. | Tutorial |
| [Mixamo Motion as Beginner Blender Reference](#case-25) | このケースは次に使えます: adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Composition Reference with Person and Vehicle Refs](#case-26) | このケースは次に使えます: adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow. | Tutorial |

### [🛠️ Production Pipelines & Toolchains](#production-pipelines-toolchains)

| ケース | 内容 | Type |
|---|---|---|
| [Hermes, Krea, ComfyUI and Blender MCP Stack](#case-27) | このケースは次に使えます: adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow. | Integration |
| [Blender MCP Viewport to Seedance Style Transfer](#case-28) | このケースは次に使えます: adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Seedance Pro Viewport Style Transfer](#case-29) | このケースは次に使えます: adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Blender Previz to Anime Seedance Render](#case-30) | このケースは次に使えます: adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow. | Integration |
| [FBX Clay Pass with Claude-Keyframed Camera](#case-31) | このケースは次に使えます: adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow. | Integration |
| [Two-Night Hybrid Short Film Pipeline](#case-32) | このケースは次に使えます: adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow. | Integration |

### [🧪 Limits, Tests & Troubleshooting](#limits-tests-troubleshooting)

| ケース | 内容 | Type |
|---|---|---|
| [Camera Rhythm Control and Foot-Sliding Limits](#case-33) | このケースは次に使えます: adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow. | Limit |
| [Reference-Only Blender Blockout without Start Frame](#case-34) | このケースは次に使えます: adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow. | Limit |
| [Mixamo Multi-Character Storyboard Experiment](#case-35) | このケースは次に使えます: adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow. | Limit |
...
**このケースは次に使えます: adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow.**

- ソースメモ: curated because the source describes a concrete Blender + Seedance workflow rather than a generic showcase.
...
**このケースは次に使えます: adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow.**
...
**このケースは次に使えます: adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow.**
