...
<a href="#conversion-path-pending"><img src="images/ko.png" alt="Blender + Seedance usecase repository banner" width="760"></a>
...
**Blender, Blender MCP, viewport, previs, FBX, Mixamo, ComfyUI, agent 기반 워크플로로 Seedance 비디오 생성을 제어한 실제 사례를 모았습니다.**

현재 컬렉션은 소유자가 제공한 X/Twitter 데이터에서 선별했습니다. 각 사례는 원본 게시물과 제작자 프로필로 연결됩니다.

주요 랜딩 페이지는 아직 미정입니다. 예정 경로는 MCP 설치, EvoLink skill 설치, 충전, agent 안에서 사용입니다.
...
최종 landing 이 제공되기 전까지 Seedance reference-to-video 모델 경로를 기록합니다.
...
최종 landing 은 아직 미정입니다. release-ready 로 표시하기 전에 이 섹션을 최종 CTA 로 교체하세요.
...
| [🙏 감사의 말](#acknowledge) | Credits and correction policy |

### [🎥 Camera Control & Previs](#camera-control-previs)

| 사례 | 보여주는 것 | Type |
|---|---|---|
| [Blender Blockout as Seedance Motion Reference](#case-1) | 이 사례를 활용해 adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow. | Demo |
| [Camera Blocking with Midjourney Start Frame](#case-2) | 이 사례를 활용해 adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [ComfyUI Camera Control with Blender Previs](#case-3) | 이 사례를 활용해 adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow. | Demo |
| [Blender Viewport as Scene Direction](#case-4) | 이 사례를 활용해 adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview for Character Animation](#case-5) | 이 사례를 활용해 adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow. | Demo |
| [Navigable AI Filmmaking with Claude and Blender](#case-6) | 이 사례를 활용해 adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview to Realistic Start Frame](#case-7) | 이 사례를 활용해 adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [One Reference Video, Multiple Worlds](#case-8) | 이 사례를 활용해 adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow. | Demo |

### [🎬 Character & Action Blocking](#character-action-blocking)

| 사례 | 보여주는 것 | Type |
|---|---|---|
| [Multi-Character Dialogue with Matched Poses](#case-9) | 이 사례를 활용해 adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow. | Demo |
| [Basic Shapes for Multi-Character Shots](#case-10) | 이 사례를 활용해 adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow. | Demo |
| [Action Choreography from Rough Blender Timing](#case-11) | 이 사례를 활용해 adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow. | Demo |
| [Handheld Follow Camera through Space](#case-12) | 이 사례를 활용해 adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow. | Demo |
| [Camera and Character Blocking for Tactical Action](#case-13) | 이 사례를 활용해 adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow. | Demo |

### [🤖 Agentic Blender MCP](#agentic-blender-mcp)

| 사례 | 보여주는 것 | Type |
|---|---|---|
| [Codex + Blender MCP Reference Video Workflow](#case-14) | 이 사례를 활용해 adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow. | Integration |
| [No-Click Blender Animation with Agent Assistance](#case-15) | 이 사례를 활용해 adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow. | Integration |
| [One-Prompt Blender MCP Blockout](#case-16) | 이 사례를 활용해 adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow. | Integration |
| [Codex-Built Architecture and Camera Work](#case-17) | 이 사례를 활용해 adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow. | Integration |
| [Beginner Agent-Assisted HIPHOP Reference Test](#case-18) | 이 사례를 활용해 adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow. | Integration |
| [Codex MCP Direct Blender Export](#case-19) | 이 사례를 활용해 adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow. | Integration |

### [🧩 Reference, Prompt & Multi-Input Mapping](#reference-prompt-multi-input-mapping)

| 사례 | 보여주는 것 | Type |
|---|---|---|
| [Reproducible Seedance Prompt with Blender Reference](#case-20) | 이 사례를 활용해 adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Character Mapping from Blocking and Reference Images](#case-21) | 이 사례를 활용해 adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow. | Tutorial |
| [FBX Animation Export as Seedance Reference](#case-22) | 이 사례를 활용해 adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Director Checklist for Camera and Lens Control](#case-23) | 이 사례를 활용해 adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow. | Tutorial |
| [Action Shot Direction with Blender Camera Planning](#case-24) | 이 사례를 활용해 adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow. | Tutorial |
| [Mixamo Motion as Beginner Blender Reference](#case-25) | 이 사례를 활용해 adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Composition Reference with Person and Vehicle Refs](#case-26) | 이 사례를 활용해 adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow. | Tutorial |

### [🛠️ Production Pipelines & Toolchains](#production-pipelines-toolchains)

| 사례 | 보여주는 것 | Type |
|---|---|---|
| [Hermes, Krea, ComfyUI and Blender MCP Stack](#case-27) | 이 사례를 활용해 adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow. | Integration |
| [Blender MCP Viewport to Seedance Style Transfer](#case-28) | 이 사례를 활용해 adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Seedance Pro Viewport Style Transfer](#case-29) | 이 사례를 활용해 adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Blender Previz to Anime Seedance Render](#case-30) | 이 사례를 활용해 adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow. | Integration |
| [FBX Clay Pass with Claude-Keyframed Camera](#case-31) | 이 사례를 활용해 adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow. | Integration |
| [Two-Night Hybrid Short Film Pipeline](#case-32) | 이 사례를 활용해 adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow. | Integration |

### [🧪 Limits, Tests & Troubleshooting](#limits-tests-troubleshooting)

| 사례 | 보여주는 것 | Type |
|---|---|---|
| [Camera Rhythm Control and Foot-Sliding Limits](#case-33) | 이 사례를 활용해 adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow. | Limit |
| [Reference-Only Blender Blockout without Start Frame](#case-34) | 이 사례를 활용해 adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow. | Limit |
| [Mixamo Multi-Character Storyboard Experiment](#case-35) | 이 사례를 활용해 adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow. | Limit |
...
**이 사례를 활용해 adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow.**

- 소스 메모: curated because the source describes a concrete Blender + Seedance workflow rather than a generic showcase.
...
**이 사례를 활용해 adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow.**
...
**이 사례를 활용해 adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow.**
