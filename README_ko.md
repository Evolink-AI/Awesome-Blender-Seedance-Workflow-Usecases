...
- 소유자가 제공한 공개 제작자 게시물 데이터에서 **20개의 Blender + Seedance 사례**를 선별했습니다.
...
| 섹션 | 사례 |
|---|---|
| [🎥 Camera Control & Previs / 카메라 제어와 프리비즈](#camera-control-previs) | Case 1-5 |
| [🎬 Character & Action Blocking / 캐릭터와 액션 블로킹](#character-action-blocking) | Case 6-9 |
| [🤖 Agentic Blender MCP / 에이전트 기반 Blender MCP](#agentic-blender-mcp) | Case 10-11 |
| [🧩 Reference, Prompt & Multi-Input Mapping / 레퍼런스, 프롬프트, 다중 입력 매핑](#reference-prompt-multi-input-mapping) | Case 12-14 |
| [🛠️ Production Pipelines & Toolchains / 제작 파이프라인과 툴체인](#production-pipelines-toolchains) | Case 15-18 |
| [🧪 Limits, Tests & Troubleshooting / 한계, 테스트, 문제 해결](#limits-tests-troubleshooting) | Case 19-20 |
...
- 소스 메모: The post describes the whole loop from image-model start frame to crude Blender camera blockout and Seedance motion-reference generation.
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2069074144986021888-1920x2160.mp4](media/case-02/video-2069074144986021888-1920x2160.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070258074795868160-1080x1920.mp4](media/case-03/video-2070258074795868160-1080x1920.mp4)
...
- 소스 메모: The post gives a concise workflow with concrete artifacts: viewport preview, first-frame image, and Seedance reference video.
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070441712242319360-1920x2160.mp4](media/case-04/video-2070441712242319360-1920x2160.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2071307859149631488-1920x1080.mp4](media/case-05/video-2071307859149631488-1920x1080.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2069409826589818880-1920x2160.mp4](media/case-06/video-2069409826589818880-1920x2160.mp4)
...
- 소스 메모: The source focuses on action timing, speed, rough camera shake, and spatial choreography rather than only camera path.
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070142533275877376-1440x2160.mp4](media/case-07/video-2070142533275877376-1440x2160.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070507396921733120-1440x2160.mp4](media/case-08/video-2070507396921733120-1440x2160.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070742547706880000-1920x1080.mp4](media/case-09/video-2070742547706880000-1920x1080.mp4), [video-2070742709737029632-1920x1080.mp4](media/case-09/video-2070742709737029632-1920x1080.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2071081165398958080-1080x1440.mp4](media/case-10/video-2071081165398958080-1080x1440.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [image-01.jpg](media/case-11/image-01.jpg), [video-2071051005316521984-1080x1216.mp4](media/case-11/video-2071051005316521984-1080x1216.mp4)
...
- 소스 메모: The post includes setup conditions and prompt constraints, so it can be reused as a reproducible reference-video case.
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [image-01.jpg](media/case-12/image-01.jpg), [video-2070864756530171904-810x1080.mp4](media/case-12/video-2070864756530171904-810x1080.mp4)
...
- 소스 메모: The source explains how to pair a blocking reference with multiple still references so Seedance maps the moving figures correctly.
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [image-01.jpg](media/case-13/image-01.jpg), [image-02.jpg](media/case-13/image-02.jpg), [image-03.jpg](media/case-13/image-03.jpg)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070683855447871488-1920x2160.mp4](media/case-14/video-2070683855447871488-1920x2160.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [image-01.jpg](media/case-15/image-01.jpg), [video-2069656156398850048-3072x1728.mp4](media/case-15/video-2069656156398850048-3072x1728.mp4), [video-2069656297624969216-1280x720.mp4](media/case-15/video-2069656297624969216-1280x720.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [image-01.jpg](media/case-16/image-01.jpg), [video-2070810169966018561-1920x1080.mp4](media/case-16/video-2070810169966018561-1920x1080.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070086817710211072-1000x1100.mp4](media/case-17/video-2070086817710211072-1000x1100.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070182579253215232-1916x1080.mp4](media/case-18/video-2070182579253215232-1916x1080.mp4)
...
- 소스 메모: This is kept as a troubleshooting case because it names what Blender controlled well and where the motion still failed.
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070864673227038720-1920x1080.mp4](media/case-19/video-2070864673227038720-1920x1080.mp4)
...
- Audit status: kept after manual duplicate and originality review.
- 로컬 미디어: [video-2070709263517847552-1080x1350.mp4](media/case-20/video-2070709263517847552-1080x1350.mp4)
