...
<a href="#conversion-path-pending"><img src="images/pt.png" alt="Blender + Seedance usecase repository banner" width="760"></a>
...
A landing principal está pendente; a rota prevista é instalar MCP, instalar a skill EvoLink, recarregar e usar no agente.
...
Esta seção registra o caminho esperado do modelo Seedance reference-to-video até a landing final existir.
...
## 🚧 Caminho de conversão pendente

A landing final ainda está pendente. Substitua esta seção pelo CTA final antes de marcar o repositório como pronto para release.
...
| [🙏 Agradecimentos](#acknowledge) | Credits and correction policy |

### [🎥 Camera Control & Previs](#camera-control-previs)

| Caso | O que mostra | Tipo |
|---|---|---|
| [Blender Blockout as Seedance Motion Reference](#case-1) | Use este caso para adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow. | Demo |
| [Camera Blocking with Midjourney Start Frame](#case-2) | Use este caso para adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [ComfyUI Camera Control with Blender Previs](#case-3) | Use este caso para adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow. | Demo |
| [Blender Viewport as Scene Direction](#case-4) | Use este caso para adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview for Character Animation](#case-5) | Use este caso para adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow. | Demo |
| [Navigable AI Filmmaking with Claude and Blender](#case-6) | Use este caso para adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview to Realistic Start Frame](#case-7) | Use este caso para adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [One Reference Video, Multiple Worlds](#case-8) | Use este caso para adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow. | Demo |

### [🎬 Character & Action Blocking](#character-action-blocking)

| Caso | O que mostra | Tipo |
|---|---|---|
| [Multi-Character Dialogue with Matched Poses](#case-9) | Use este caso para adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow. | Demo |
| [Basic Shapes for Multi-Character Shots](#case-10) | Use este caso para adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow. | Demo |
| [Action Choreography from Rough Blender Timing](#case-11) | Use este caso para adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow. | Demo |
| [Handheld Follow Camera through Space](#case-12) | Use este caso para adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow. | Demo |
| [Camera and Character Blocking for Tactical Action](#case-13) | Use este caso para adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow. | Demo |

### [🤖 Agentic Blender MCP](#agentic-blender-mcp)

| Caso | O que mostra | Tipo |
|---|---|---|
| [Codex + Blender MCP Reference Video Workflow](#case-14) | Use este caso para adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow. | Integration |
| [No-Click Blender Animation with Agent Assistance](#case-15) | Use este caso para adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow. | Integration |
| [One-Prompt Blender MCP Blockout](#case-16) | Use este caso para adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow. | Integration |
| [Codex-Built Architecture and Camera Work](#case-17) | Use este caso para adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow. | Integration |
| [Beginner Agent-Assisted HIPHOP Reference Test](#case-18) | Use este caso para adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow. | Integration |
| [Codex MCP Direct Blender Export](#case-19) | Use este caso para adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow. | Integration |

### [🧩 Reference, Prompt & Multi-Input Mapping](#reference-prompt-multi-input-mapping)

| Caso | O que mostra | Tipo |
|---|---|---|
| [Reproducible Seedance Prompt with Blender Reference](#case-20) | Use este caso para adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Character Mapping from Blocking and Reference Images](#case-21) | Use este caso para adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow. | Tutorial |
| [FBX Animation Export as Seedance Reference](#case-22) | Use este caso para adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Director Checklist for Camera and Lens Control](#case-23) | Use este caso para adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow. | Tutorial |
| [Action Shot Direction with Blender Camera Planning](#case-24) | Use este caso para adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow. | Tutorial |
| [Mixamo Motion as Beginner Blender Reference](#case-25) | Use este caso para adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Composition Reference with Person and Vehicle Refs](#case-26) | Use este caso para adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow. | Tutorial |

### [🛠️ Production Pipelines & Toolchains](#production-pipelines-toolchains)

| Caso | O que mostra | Tipo |
|---|---|---|
| [Hermes, Krea, ComfyUI and Blender MCP Stack](#case-27) | Use este caso para adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow. | Integration |
| [Blender MCP Viewport to Seedance Style Transfer](#case-28) | Use este caso para adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Seedance Pro Viewport Style Transfer](#case-29) | Use este caso para adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Blender Previz to Anime Seedance Render](#case-30) | Use este caso para adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow. | Integration |
| [FBX Clay Pass with Claude-Keyframed Camera](#case-31) | Use este caso para adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow. | Integration |
| [Two-Night Hybrid Short Film Pipeline](#case-32) | Use este caso para adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow. | Integration |

### [🧪 Limits, Tests & Troubleshooting](#limits-tests-troubleshooting)

| Caso | O que mostra | Tipo |
|---|---|---|
| [Camera Rhythm Control and Foot-Sliding Limits](#case-33) | Use este caso para adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow. | Limit |
| [Reference-Only Blender Blockout without Start Frame](#case-34) | Use este caso para adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow. | Limit |
| [Mixamo Multi-Character Storyboard Experiment](#case-35) | Use este caso para adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow. | Limit |
...
**Use este caso para adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow.**

- Notas da fonte: curated because the source describes a concrete Blender + Seedance workflow rather than a generic showcase.
...
**Use este caso para adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow.**
...
Tipo: Integration | Data: 2026-06-26
...
**Use este caso para adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow.**
...
**Use este caso para adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow.**
