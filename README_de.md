...
<a href="#conversion-path-pending"><img src="images/de.png" alt="Blender + Seedance usecase repository banner" width="760"></a>
...
Usecase-Repository für Blender + Seedance.

**Wir sammeln reale Workflows mit Blender, Blender MCP, Viewport, Previs, FBX, Mixamo, ComfyUI und Agentensteuerung für Seedance-Videogenerierung.**

Die aktuelle Sammlung stammt aus vom Owner bereitgestellten X/Twitter-Daten. Jeder Fall verlinkt Quelle und Creator-Profil.

Die primäre Landingpage fehlt noch; der geplante Pfad ist MCP installieren, EvoLink Skill installieren, aufladen und im Agenten nutzen.
...
> [!NOTE]
> Die Sammlung bevorzugt konkrete Evidenz: Schritte, Referenzvideos, Agent/MCP-Nutzung, reproduzierbare Bedingungen und klare Grenzen.

<a id="-quick-api-access"></a>
## ⚡ Schneller API-Zugang

Bis zur finalen Landingpage dokumentiert dieser Abschnitt den erwarteten Seedance reference-to-video Modellpfad.
...
## 🚧 Conversion-Pfad ausstehend

Die finale Landingpage steht noch aus. Ersetze diesen Abschnitt durch den finalen CTA, bevor das Repository als release-ready gilt.
...
| [🙏 Danksagung](#acknowledge) | Credits and correction policy |

### [🎥 Camera Control & Previs](#camera-control-previs)

| Fall | Was es zeigt | Typ |
|---|---|---|
| [Blender Blockout as Seedance Motion Reference](#case-1) | Nutze diesen Fall, um adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow. | Demo |
| [Camera Blocking with Midjourney Start Frame](#case-2) | Nutze diesen Fall, um adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [ComfyUI Camera Control with Blender Previs](#case-3) | Nutze diesen Fall, um adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow. | Demo |
| [Blender Viewport as Scene Direction](#case-4) | Nutze diesen Fall, um adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview for Character Animation](#case-5) | Nutze diesen Fall, um adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow. | Demo |
| [Navigable AI Filmmaking with Claude and Blender](#case-6) | Nutze diesen Fall, um adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview to Realistic Start Frame](#case-7) | Nutze diesen Fall, um adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [One Reference Video, Multiple Worlds](#case-8) | Nutze diesen Fall, um adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow. | Demo |

### [🎬 Character & Action Blocking](#character-action-blocking)

| Fall | Was es zeigt | Typ |
|---|---|---|
| [Multi-Character Dialogue with Matched Poses](#case-9) | Nutze diesen Fall, um adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow. | Demo |
| [Basic Shapes for Multi-Character Shots](#case-10) | Nutze diesen Fall, um adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow. | Demo |
| [Action Choreography from Rough Blender Timing](#case-11) | Nutze diesen Fall, um adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow. | Demo |
| [Handheld Follow Camera through Space](#case-12) | Nutze diesen Fall, um adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow. | Demo |
| [Camera and Character Blocking for Tactical Action](#case-13) | Nutze diesen Fall, um adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow. | Demo |

### [🤖 Agentic Blender MCP](#agentic-blender-mcp)

| Fall | Was es zeigt | Typ |
|---|---|---|
| [Codex + Blender MCP Reference Video Workflow](#case-14) | Nutze diesen Fall, um adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow. | Integration |
| [No-Click Blender Animation with Agent Assistance](#case-15) | Nutze diesen Fall, um adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow. | Integration |
| [One-Prompt Blender MCP Blockout](#case-16) | Nutze diesen Fall, um adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow. | Integration |
| [Codex-Built Architecture and Camera Work](#case-17) | Nutze diesen Fall, um adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow. | Integration |
| [Beginner Agent-Assisted HIPHOP Reference Test](#case-18) | Nutze diesen Fall, um adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow. | Integration |
| [Codex MCP Direct Blender Export](#case-19) | Nutze diesen Fall, um adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow. | Integration |

### [🧩 Reference, Prompt & Multi-Input Mapping](#reference-prompt-multi-input-mapping)

| Fall | Was es zeigt | Typ |
|---|---|---|
| [Reproducible Seedance Prompt with Blender Reference](#case-20) | Nutze diesen Fall, um adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Character Mapping from Blocking and Reference Images](#case-21) | Nutze diesen Fall, um adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow. | Tutorial |
| [FBX Animation Export as Seedance Reference](#case-22) | Nutze diesen Fall, um adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Director Checklist for Camera and Lens Control](#case-23) | Nutze diesen Fall, um adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow. | Tutorial |
| [Action Shot Direction with Blender Camera Planning](#case-24) | Nutze diesen Fall, um adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow. | Tutorial |
| [Mixamo Motion as Beginner Blender Reference](#case-25) | Nutze diesen Fall, um adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Composition Reference with Person and Vehicle Refs](#case-26) | Nutze diesen Fall, um adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow. | Tutorial |

### [🛠️ Production Pipelines & Toolchains](#production-pipelines-toolchains)

| Fall | Was es zeigt | Typ |
|---|---|---|
| [Hermes, Krea, ComfyUI and Blender MCP Stack](#case-27) | Nutze diesen Fall, um adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow. | Integration |
| [Blender MCP Viewport to Seedance Style Transfer](#case-28) | Nutze diesen Fall, um adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Seedance Pro Viewport Style Transfer](#case-29) | Nutze diesen Fall, um adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Blender Previz to Anime Seedance Render](#case-30) | Nutze diesen Fall, um adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow. | Integration |
| [FBX Clay Pass with Claude-Keyframed Camera](#case-31) | Nutze diesen Fall, um adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow. | Integration |
| [Two-Night Hybrid Short Film Pipeline](#case-32) | Nutze diesen Fall, um adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow. | Integration |

### [🧪 Limits, Tests & Troubleshooting](#limits-tests-troubleshooting)

| Fall | Was es zeigt | Typ |
|---|---|---|
| [Camera Rhythm Control and Foot-Sliding Limits](#case-33) | Nutze diesen Fall, um adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow. | Limit |
| [Reference-Only Blender Blockout without Start Frame](#case-34) | Nutze diesen Fall, um adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow. | Limit |
| [Mixamo Multi-Character Storyboard Experiment](#case-35) | Nutze diesen Fall, um adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow. | Limit |
...
**Nutze diesen Fall, um adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow.**

- Quellnotizen: curated because the source describes a concrete Blender + Seedance workflow rather than a generic showcase.
...
**Nutze diesen Fall, um adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow.**
...
Typ: Integration | Datum: 2026-06-26
...
**Nutze diesen Fall, um adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow.**
...
**Nutze diesen Fall, um adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow.**
