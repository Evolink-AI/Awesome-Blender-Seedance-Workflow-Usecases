...
Empieza desde el cookbook Blender-to-video de EvoLink y usa el Quick Start de abajo como referencia local del workflow.
...
### 3. [Obtén una API key](https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=awesome-blender-seedance-workflow-usecases&utm_content=quick_start_api_key)
...
- Notas de la fuente: The post gives a concise workflow with concrete artifacts: viewport preview, first-frame image, and Seedance reference video. The duplicate case 29 media was removed so the public case shows only one copy of the same video.
- Audit status: kept after manual duplicate and originality review.
- Vista previa de video:
