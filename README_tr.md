...
|---|---|---|
| [Blender Blockout as Seedance Motion Reference](#case-1) | Bu vakayı şunun için kullanın: adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow. | Demo |
| [Camera Blocking with Midjourney Start Frame](#case-2) | Bu vakayı şunun için kullanın: adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [ComfyUI Camera Control with Blender Previs](#case-3) | Bu vakayı şunun için kullanın: adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow. | Demo |
| [Blender Viewport as Scene Direction](#case-4) | Bu vakayı şunun için kullanın: adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview for Character Animation](#case-5) | Bu vakayı şunun için kullanın: adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow. | Demo |
| [Navigable AI Filmmaking with Claude and Blender](#case-6) | Bu vakayı şunun için kullanın: adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow. | Demo |
| [Viewport Preview to Realistic Start Frame](#case-7) | Bu vakayı şunun için kullanın: adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow. | Demo |
| [One Reference Video, Multiple Worlds](#case-8) | Bu vakayı şunun için kullanın: adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow. | Demo |

### [🎬 Character & Action Blocking](#character-action-blocking)

| Vaka | Ne gösteriyor | Tür |
|---|---|---|
| [Multi-Character Dialogue with Matched Poses](#case-9) | Bu vakayı şunun için kullanın: adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow. | Demo |
| [Basic Shapes for Multi-Character Shots](#case-10) | Bu vakayı şunun için kullanın: adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow. | Demo |
| [Action Choreography from Rough Blender Timing](#case-11) | Bu vakayı şunun için kullanın: adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow. | Demo |
| [Handheld Follow Camera through Space](#case-12) | Bu vakayı şunun için kullanın: adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow. | Demo |
| [Camera and Character Blocking for Tactical Action](#case-13) | Bu vakayı şunun için kullanın: adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow. | Demo |

### [🤖 Agentic Blender MCP](#agentic-blender-mcp)

| Vaka | Ne gösteriyor | Tür |
|---|---|---|
| [Codex + Blender MCP Reference Video Workflow](#case-14) | Bu vakayı şunun için kullanın: adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow. | Integration |
| [No-Click Blender Animation with Agent Assistance](#case-15) | Bu vakayı şunun için kullanın: adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow. | Integration |
| [One-Prompt Blender MCP Blockout](#case-16) | Bu vakayı şunun için kullanın: adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow. | Integration |
| [Codex-Built Architecture and Camera Work](#case-17) | Bu vakayı şunun için kullanın: adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow. | Integration |
| [Beginner Agent-Assisted HIPHOP Reference Test](#case-18) | Bu vakayı şunun için kullanın: adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow. | Integration |
| [Codex MCP Direct Blender Export](#case-19) | Bu vakayı şunun için kullanın: adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow. | Integration |

### [🧩 Reference, Prompt & Multi-Input Mapping](#reference-prompt-multi-input-mapping)

| Vaka | Ne gösteriyor | Tür |
|---|---|---|
| [Reproducible Seedance Prompt with Blender Reference](#case-20) | Bu vakayı şunun için kullanın: adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Character Mapping from Blocking and Reference Images](#case-21) | Bu vakayı şunun için kullanın: adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow. | Tutorial |
| [FBX Animation Export as Seedance Reference](#case-22) | Bu vakayı şunun için kullanın: adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Director Checklist for Camera and Lens Control](#case-23) | Bu vakayı şunun için kullanın: adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow. | Tutorial |
| [Action Shot Direction with Blender Camera Planning](#case-24) | Bu vakayı şunun için kullanın: adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow. | Tutorial |
| [Mixamo Motion as Beginner Blender Reference](#case-25) | Bu vakayı şunun için kullanın: adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow. | Tutorial |
| [Composition Reference with Person and Vehicle Refs](#case-26) | Bu vakayı şunun için kullanın: adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow. | Tutorial |

### [🛠️ Production Pipelines & Toolchains](#production-pipelines-toolchains)

| Vaka | Ne gösteriyor | Tür |
|---|---|---|
| [Hermes, Krea, ComfyUI and Blender MCP Stack](#case-27) | Bu vakayı şunun için kullanın: adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow. | Integration |
| [Blender MCP Viewport to Seedance Style Transfer](#case-28) | Bu vakayı şunun için kullanın: adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Seedance Pro Viewport Style Transfer](#case-29) | Bu vakayı şunun için kullanın: adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow. | Integration |
| [Blender Previz to Anime Seedance Render](#case-30) | Bu vakayı şunun için kullanın: adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow. | Integration |
| [FBX Clay Pass with Claude-Keyframed Camera](#case-31) | Bu vakayı şunun için kullanın: adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow. | Integration |
| [Two-Night Hybrid Short Film Pipeline](#case-32) | Bu vakayı şunun için kullanın: adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow. | Integration |

### [🧪 Limits, Tests & Troubleshooting](#limits-tests-troubleshooting)

| Vaka | Ne gösteriyor | Tür |
|---|---|---|
| [Camera Rhythm Control and Foot-Sliding Limits](#case-33) | Bu vakayı şunun için kullanın: adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow. | Limit |
| [Reference-Only Blender Blockout without Start Frame](#case-34) | Bu vakayı şunun için kullanın: adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow. | Limit |
| [Mixamo Multi-Character Storyboard Experiment](#case-35) | Bu vakayı şunun için kullanın: adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow. | Limit |
...
**Bu vakayı şunun için kullanın: adapt 'Blender Blockout as Seedance Motion Reference' into a Blender-guided Seedance workflow.**

- Kaynak notları: curated because the source describes a concrete Blender + Seedance workflow rather than a generic showcase.
...
**Bu vakayı şunun için kullanın: adapt 'Camera Blocking with Midjourney Start Frame' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'ComfyUI Camera Control with Blender Previs' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Blender Viewport as Scene Direction' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Viewport Preview for Character Animation' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Navigable AI Filmmaking with Claude and Blender' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Viewport Preview to Realistic Start Frame' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'One Reference Video, Multiple Worlds' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Multi-Character Dialogue with Matched Poses' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Basic Shapes for Multi-Character Shots' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Action Choreography from Rough Blender Timing' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Handheld Follow Camera through Space' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Camera and Character Blocking for Tactical Action' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Codex + Blender MCP Reference Video Workflow' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'No-Click Blender Animation with Agent Assistance' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'One-Prompt Blender MCP Blockout' into a Blender-guided Seedance workflow.**
...
Tür: Integration | Tarih: 2026-06-26
...
**Bu vakayı şunun için kullanın: adapt 'Codex-Built Architecture and Camera Work' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Beginner Agent-Assisted HIPHOP Reference Test' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Codex MCP Direct Blender Export' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Reproducible Seedance Prompt with Blender Reference' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Character Mapping from Blocking and Reference Images' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'FBX Animation Export as Seedance Reference' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Director Checklist for Camera and Lens Control' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Action Shot Direction with Blender Camera Planning' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Mixamo Motion as Beginner Blender Reference' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Composition Reference with Person and Vehicle Refs' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Hermes, Krea, ComfyUI and Blender MCP Stack' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Blender MCP Viewport to Seedance Style Transfer' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Seedance Pro Viewport Style Transfer' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Blender Previz to Anime Seedance Render' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'FBX Clay Pass with Claude-Keyframed Camera' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Two-Night Hybrid Short Film Pipeline' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Camera Rhythm Control and Foot-Sliding Limits' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Reference-Only Blender Blockout without Start Frame' into a Blender-guided Seedance workflow.**
...
**Bu vakayı şunun için kullanın: adapt 'Mixamo Multi-Character Storyboard Experiment' into a Blender-guided Seedance workflow.**
